...
CORS_ALLOWED_ORIGINS = config(
    ...
    default="http://localhost:3000,http://127.0.0.1:3000,http://localhost:4200,http://127.0.0.1:4200",
    cast=lambda v: [s.strip() for s in v.split(",")]
)
...
CSRF_TRUSTED_ORIGINS = config(
    ...
    default="http://127.0.0.1:8000,http://localhost:8000,http://localhost:4200,http://127.0.0.1:4200",
    cast=lambda v: [s.strip() for s in v.split(",")]
)
